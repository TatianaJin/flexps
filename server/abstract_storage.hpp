...
class AbstractStorage {
 public:
  ...
  virtual void SubAddChunk(const third_party::SArray<Key>& typed_keys, const third_party::SArray<char>& vals) = 0;
  ...
  virtual void WriteTo(const std::string&) = 0;
  virtual void LoadFrom(const std::string&) = 0;
